...
# Step 3: Select Allen & User resolutions (in microns)
st.subheader('Step 3: Select Allen & User resolutions (in microns)')
allen_res = st.radio('Allen resolution', [25, 50, 100])
user_res = st.number_input('User resolution', value=0, step=1)

# Step 4: Run the script
st.subheader('Step 4: Compute affine transformation matrix')
if st.button('Compute matrix') and ref and out_mat and allen_res and user_res:
    with tempfile.TemporaryDirectory() as tempdir:
        ...
        try:
            ...
            st.subheader('Step 5: Download affine transformation matrix')
